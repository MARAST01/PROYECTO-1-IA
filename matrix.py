...
class MatrixEditorApp(ctk.CTk):
    def __init__(self):
        ...
        self.queso = None  # Coordenadas del queso
    ...
    def update_matrix_size(self):
        ...
        try:
            ...
            if rows > 0 and cols > 0:
                ...
                ctk.CTkMessagebox.show_info("Éxito", f"Tamaño de la matriz actualizado a {rows}x{cols}.")
            else:
    ...
    def save_matrix_to_file(self):
        """Guarda la matriz en el archivo Laberinto.py."""
        try:
    ...
    def create_matrix_grid(self):
        ...
        for i, row in enumerate(self.matrix):
            ...
            for j, value in enumerate(row):
                btn = ctk.CTkButton(self, text=str(value), width=40, height=40, command=lambda i=i, j=j: self.toggle_cell(i, j))
